-- ============================================
-- CORRIGIR FUNÇÃO COM CAST SEGURO
-- ============================================
-- Versão que trata o cast do ENUM de forma segura
...
DECLARE
  ...
  v_plan_type TEXT;
  v_plan_type_enum plan_type;  -- Variável do tipo ENUM
  v_account_type TEXT;
  v_coupon_id UUID;
BEGIN
  -- 1. Buscar cupom
  ...
  -- CORREÇÃO: Fazer cast seguro para ENUM
  BEGIN
    -- Tentar fazer cast para ENUM
    v_plan_type_enum := v_plan_type::plan_type;
  EXCEPTION WHEN OTHERS THEN
    -- Se o cast falhar, usar 'free' como padrão
    v_plan_type_enum := 'free'::plan_type;
    v_plan_type := 'free';
  END;
  
  -- Atualizar perfil usando a variável ENUM
  UPDATE user_profiles
  SET 
    plan_type = v_plan_type_enum,  -- Usar variável ENUM diretamente
