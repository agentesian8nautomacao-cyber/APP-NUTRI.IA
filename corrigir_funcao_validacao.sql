-- ============================================
-- CORRIGIR FUNÇÃO COM VALIDAÇÃO ROBUSTA
-- ============================================
-- Garante que plan_linked seja mapeado corretamente para plan_type
...
DECLARE
  ...
  v_plan_type plan_type; -- Mudança: usar ENUM diretamente
  v_account_type account_type; -- Mudança: usar ENUM diretamente
  v_coupon_id UUID;
...
BEGIN
  ...
  -- 4. Mapear plan_linked para plan_type ENUM
  ...
  -- 5. Determinar account_type esperado
  ...
  -- 7. Decrementar quantidade_disponivel e incrementar current_uses atomicamente
  UPDATE coupons
  SET 
  ...
  -- 8. Atualizar perfil do usuário com o plano (usando ENUM diretamente)
  UPDATE user_profiles
  SET 
    plan_type = v_plan_type, -- Agora é ENUM direto, sem cast
    subscription_status = 'active',
    account_type = v_account_type, -- Agora é ENUM direto
    updated_at = now()
  WHERE id = p_user_id;
  
  -- 9. Criar vínculo na tabela user_coupon_links (se não existir)
